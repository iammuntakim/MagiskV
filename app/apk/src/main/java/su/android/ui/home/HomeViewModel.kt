...
class HomeViewModel(
    ...
    val supersuTitleBarrierIds =
        intArrayOf(R.id.home_supersu_icon, R.id.home_supersu_title, R.id.home_supersu_button)
    ...
    fun onSuperSUPressed() = withExternalRW {
    ...
    private suspend fun ensureEnv() {
        if (supersuState == State.INVALID || checkedEnv) return
