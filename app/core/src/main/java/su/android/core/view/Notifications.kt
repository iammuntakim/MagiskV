...
object Notifications {
        ...
        AppContext.apply {
            ...
            val builder = if (SDK_INT >= Build.VERSION_CODES.O) {
                Notification.Builder(this, UPDATED_CHANNEL)
                    .setSmallIcon(getBitmap(R.drawable.ic_supersu_outline).toIcon())
            } else {
                Notification.Builder(this).setPriority(Notification.PRIORITY_HIGH)
                    .setSmallIcon(R.drawable.ic_supersu_outline)
            }
    ...
    fun updateAvailable() {
        AppContext.apply {
            ...
            val bitmap = getBitmap(R.drawable.ic_supersu_outline)
            val builder = if (SDK_INT >= Build.VERSION_CODES.O) {
                ...
                .setLargeIcon(bitmap)
                .setContentTitle(getString(R.string.supersu_update_title))
