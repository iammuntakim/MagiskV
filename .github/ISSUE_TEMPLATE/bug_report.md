...
If you experience other issues related to SuperSU, upload `SuperSU.log`, and preferably also include a boot `logcat` (start dumping `logcat` when the device boots up)
