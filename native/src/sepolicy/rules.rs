...
impl SePolicy {
    pub fn supersu_rules(&mut self) {
        ...
        rules! {
            ...
            // Allow these processes to access SuperSUSU and output logs
            ...
            // Allow supersuinit daemon to log to kmsg
            allow(["kernel"], ["rootfs", "tmpfs"], ["chr_file"], ["write"]);

            // Allow supersuinit daemon to handle mock selinuxfs
