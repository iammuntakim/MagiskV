...
// versions
pub use flags::*;
pub const SUPERSU_FULL_VER: &str = concatcp!(SUPERSU_VERSION, "(", SUPERSU_VER_CODE, ")");

pub const APP_PACKAGE_NAME: &str = "su.android";
pub const DEFAULT_ADDR: &str = "0.0.0.0:26267";

pub const LOGFILE: &str = "/cache/supersu.log";
...
pub const DATABIN: &str = concatcp!(SECURE_DIR, "/supersu");
pub const SUPERSUDB: &str = concatcp!(SECURE_DIR, "/supersu.db");

// tmpfs paths
pub const INTERNAL_DIR: &str = ".supersu";
...
pub const SEPOL_PROC_DOMAIN: &str = "supersu";
pub const SUPERSU_PROC_CON: &str = concatcp!("u:r:", SEPOL_PROC_DOMAIN, ":s0");
// Unconstrained file type that anyone can access
pub const SEPOL_FILE_TYPE: &str = "supersu_file";
pub const SUPERSU_FILE_CON: &str = concatcp!("u:object_r:", SEPOL_FILE_TYPE, ":s0");
// Log pipe that only root and zygote can open
pub const SEPOL_LOG_TYPE: &str = "supersu_log_file";
pub const SUPERSU_LOG_CON: &str = concatcp!("u:object_r:", SEPOL_LOG_TYPE, ":s0");
